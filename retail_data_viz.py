...
Monthly_Quantity_Sold_Trend_per_Price_Category_file_path = root_output_file_path + 'Monthly_Quantity_Sold_Trend_per_Price_Category.png'
Monthly_Revenue_Trend_per_Price_Category_file_path = root_output_file_path + 'Monthly_Revenue_Trend_per_Price_Category.png'
Revenue_by_Average_Selling_Price_Product_Category_High_Value_vs_Other_Customers_file_path = root_output_file_path + 'Revenue_by_Average_Selling_Price_Product_Category_High_Value_vs_Other_Customers.png'
Total_Quantity_Sold_by_Average_Selling_Price_Product_Category_High_Value_vs_Other_Customers_file_path = root_output_file_path + 'Total_Quantity_Sold_by_Average_Selling_Price_Product_Category_High_Value_vs_Other_Customers.png'
Comparison_Top_5_Selling_Products_by_Quantity_sold_across_Customer_Segment_file_path = root_output_file_path + 'Comparison_Top_5_Selling_Products_by_Quantity_sold_across_Customer_Segment.png'
Comparison_Top_5_Products_by_Revenue_they_generate_across_Customer_Segment_file_path = root_output_file_path + 'Comparison_Top_5_Products_by_Revenue_they_generate_across_Customer_Segment.png'
Pie_Revenue_Contribution_High_Value_vs_Other_Customers_file_path = root_output_file_path + 'Pie_Revenue_Contribution_High_Value_vs_Other_Customers.png'
